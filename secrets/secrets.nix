...
in
{
  "mautrix-signal.env.age".publicKeys = [
    gmacon
    silicon
  ];
  "mautrix-discord.env.age".publicKeys = [
    gmacon
    silicon
  ];
  "mautrix-gmessages.env.age".publicKeys = [
    gmacon
    silicon
  ];
  "tarsnap-ar.key.age".publicKeys = [
    gmacon
    argon
  ];
  "tarsnap-k.key.age".publicKeys = [
    gmacon
    potassium
  ];
}
